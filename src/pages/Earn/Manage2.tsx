 ...
 // const stakingInfoC =  useStakingInfo(stakingTokenPair)?.[2]
  ...
  if (totalSupplyOfStakingToken && stakingTokenPairB  && stakingInfo && WETH) {
    ...
    valueOfTotalStakedAmountInWETH = new TokenAmount(
      ...
      JSBI.divide(
        JSBI.multiply(
          JSBI.multiply(stakingInfo.totalStakedAmount.raw, stakingTokenPairB.reserveOf(WETH).raw),
      ...
      {showAddLiquidityButton && (
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Step 1. Get xETH-G tokens</TYPE.white>
              </RowBetween>
              <RowBetween style={{ marginBottom: '1rem' }}>
                <TYPE.white fontSize={14}>
                  {`xETH-G tokens are required. Once you've purchased xETH-G you can start staking on this page.`}
                </TYPE.white>
              </RowBetween>
              <ButtonPrimary
                padding="8px"
        ...
        {!showAddLiquidityButton && (
          <DataRow style={{ marginBottom: '1rem' }}>
            <ButtonPrimary padding="8px" borderRadius="8px" width="160px" onClick={handleDepositClick} >
              {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? 'Deposit' : 'Deposit xETH-G Tokens'}
            </ButtonPrimary>
