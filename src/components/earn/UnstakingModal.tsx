      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          ...
          <TYPE.subHeader style={{ textAlign: 'center', color: '#565A69' }}> 
            When you withdraw, your xETH-G is claimed and your tokens are removed from the mining pool.
          </TYPE.subHeader>
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOndismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            <TYPE.body fontSize={20}style={{ color: '#565A69' }}>Withdrawing {stakingInfo?.stakedAmount?.toSignificant(4)} xETH-G</TYPE.body>
      ...
      {hash && (
        <SubmittedView onDismiss={wrappedOndismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}style={{ color: '#565A69' }}>Withdrew xETH-G!</TYPE.body>
